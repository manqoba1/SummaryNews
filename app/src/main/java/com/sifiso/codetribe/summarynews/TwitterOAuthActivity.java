 ...
 * 4. Return to the {@link com.sifiso.codetribe.summarylib.LoginActivity} with the new access token
 */
public class TwitterOAuthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTwitter = new TwitterFactory(new ConfigurationBuilder()
                .setOAuthConsumerKey(getResources().getString(com.sifiso.codetribe.summarylib.R.string.twitter_consumer_key))
                .setOAuthConsumerSecret(getResources().getString(com.sifiso.codetribe.summarylib.R.string.twitter_consumer_secret))
                .setOAuthAccessToken(getResources().getString(com.sifiso.codetribe.summarylib.R.string.twitter_access_token))
                .setOAuthAccessTokenSecret(getResources().getString(com.sifiso.codetribe.summarylib.R.string.twitter_access_token_secret))
                .build()).getInstance();
  ...
  /*  private void loginToTwitter() {
        ...
        new AsyncTask<Void, Void, RequestToken>() {
            ...
            protected RequestToken doInBackground(Void... params) {
                ...
                try {
                    token = mTwitter.getOAuthRequestToken();
    ...
    private void getTwitterOAuthTokenAndLogin() {
